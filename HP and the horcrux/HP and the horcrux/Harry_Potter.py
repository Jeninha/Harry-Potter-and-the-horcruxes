...
TreeImg = pygame.image.load("overworld/floorest.png")
TreeImg2 = pygame.image.load("overworld/single_trees.png")
TreeImg3 = pygame.image.load("overworld/single_tree.png")
RockImg = pygame.image.load("overworld/wall.png")
DestRock = pygame.image.load("overworld/explodable_rocks.png")
Oldie = pygame.image.load("others/dumbledore.png")
dungeon_rock = pygame.image.load("overworld/dungeon_rocks.png")
Water1 = pygame.image.load("overworld/waterh.png")
Water2 = pygame.image.load("overworld/waterhp.png")
Water3 = pygame.image.load("overworld/water_right_inverse.png")
Zelda = pygame.image.load("others/voldemort.png")
Win = pygame.image.load("others/voldhp.png")
class Link(pygame.sprite.Sprite):
	...
	def __init__(self, x, y,DIRECTION,upKeyPressed,downKeyPressed,leftKeyPressed,rightKeyPressed, spacePressed,has_sword,has_bombs):
		...
		self.image = pygame.image.load("harry/harry_up1.png")
		self.right1 = pygame.image.load("harry/harry_right1.png")
		self.right2 = pygame.image.load("harry/harry_right2.png")
		self.left1 = pygame.image.load("harry/harry_left1.png")
		self.left2 = pygame.image.load("harry/harry_left2.png")
		self.up1 = pygame.image.load("harry/harry_up1.png")
		self.up2 = pygame.image.load("harry/harry_up2.png")
		self.down1 = pygame.image.load("harry/hharry.png")
		self.down2 = pygame.image.load("harry/harry_down2.png")
		self.attack_right = pygame.image.load("harry/harryattack_right.png")
		self.attack_left = pygame.image.load("harry/harryattack_left.png")
		self.attack_up = pygame.image.load("harry/harryattack_up.png")
		self.attack_down = pygame.image.load("harry/harryattacck_down.png")
...
class Mob(pygame.sprite.Sprite):
	def __init__(self,x,y,hitpoint,game):
		self.left1 = pygame.image.load("dementador/dementadorlado1.png")
		self.left2 = pygame.image.load("dementador/dementadorladoo1.png")
		self.down1 = pygame.image.load("dementador/dementador1.png")
		self.down2 = pygame.image.load("dementador/dementador2.png")
		self.right1 = pygame.image.load("dementador/dementadorlado.png")
		self.right2 = pygame.image.load("dementador/dementadorladoo.png")
		self.up1 = pygame.image.load("dementador/dementadorcosta.png")
		self.up2 = pygame.image.load("dementador/dementadorcosta1.png")
		self.left_walk = [self.left1,self.left2]
		self.right_walk = [self.right1, self.right2]
		self.up_walk = [self.up1, self.up2]
		self.down_walk = [self.down1, self.down2]
		...
		self.image = pygame.image.load("dementador/dementadorlado1.png")
		self.rect.x = x
		self.rect.y = y
		self.one = pygame.image.load("others/0.png")
		self.two = pygame.image.load("others/1.png")
		self.three= pygame.image.load("others/2.png")
...
class Mob_Arrow(pygame.sprite.Sprite):
	def __init__(self,x,y,direction):
		...
		self.direction = direction
		if self.direction == "right":
			self.image = pygame.image.load("dementador/arrow/sopro1.png")
		elif self.direction == "left":
			self.image = pygame.image.load("dementador/arrow/sopro.png")
		elif self.direction == "up":
			self.image = pygame.image.load("dementador/arrow/soprocima.png")
		elif self.direction == "down":
			self.image = pygame.image.load("dementador/arrow/soprobaixo.png")
		self.rect = self.image.get_rect()
		self.rect.x = x
		self.rect.y = y
...
class Bomb(pygame.sprite.Sprite):
	def __init__(self, x,y, link):
		pygame.sprite.Sprite.__init__(self)
		self.image =  pygame.image.load("bombs/sonserina.png")
		self.rect = self.image.get_rect()
		self.x = x
		self.y = y
		...
		self.rect.y = y
		self.timer = 100
		self.one = pygame.image.load("others/fumaça.png")
		self.two = pygame.image.load("others/1.png")
		self.three= pygame.image.load("others/2.png")
...
class Door(pygame.sprite.Sprite):
	def __init__(self,x,y):
		pygame.sprite.Sprite.__init__(self)
		self.image = pygame.image.load("harry/harry_right1.png")
		self.rect = self.image.get_rect()
...
class Sword(pygame.sprite.Sprite):
	def __init__(self, x, y):
		pygame.sprite.Sprite.__init__(self)
		self.image = pygame.image.load("varinhadasvarinnhas.png")
		self.rect = self.image.get_rect()
		self.rect.x = x
		self.rect.y = y
...
class Text(pygame.sprite.Sprite):
	def __init__(self, x, y):
		pygame.sprite.Sprite.__init__(self)
		self.image = pygame.image.load("harryalone.png")
		self.rect = self.image.get_rect()
		self.rect.x = x
		self.rect.y = y
class Key(pygame.sprite.Sprite):
	def __init__(self,x,y):
		pygame.sprite.Sprite.__init__(self)
		self.image = pygame.image.load("others/diary.png")
		self.rect = self.image.get_rect()
		self.rect.x = x
		self.rect.y = y
...
class Lock(pygame.sprite.Sprite):
	def __init__(self,x,y):
		pygame.sprite.Sprite.__init__(self)
		self.image = pygame.image.load("others/lock.png")
		self.rect = self.image.get_rect()
		self.rect.x = x
		self.rect.y = y
class Room(object):
...
class GameMain():
	...
	def __init__(self,width = 800, height = 600):
		...
		pygame.display.set_caption("Harry Potter and the Horcrux")
		self.screen = pygame.display.set_mode((self.width, self.height))
		self.clock = pygame.time.Clock()
		self.link = Link(300,600,"UP",False,False,False,False,False,False,False)        
	...
	def main_loop(self):
		pygame.mixer.music.load("LoZ_Sounds/harrypotter.ogg")
	...
	def draw_title(self):
		...
		logo = pygame.image.load("logoharrypoficial.png")
...
def menu():
	...
	play_menu.add_option('Start', play_function, pygame.font.Font('franchise.ttf', 30))
